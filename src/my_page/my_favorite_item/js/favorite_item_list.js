import '../css/favorite_item_list.css';
import axios from 'axios';
import cookie from 'react-cookies';

export default function Favorite_item_list(props) {
    ...
    return(
        <div id='favorite_item_list'>
            <div id='favorite_item_list_inner'>
                <div id='favorite_item_list_inner_img'>
                    <img alt='' src={`${img}`} onClick={view_detail_item}></img>
                </div>
                
                <div id='favorite_item_list_inner_main'>
                    <div id='favorite_item_list_inner_main_content'>
                        <p>{content}</p>
                    </div>

                    <div id='favorite_item_list_inner_main_price'>
                        <p>{price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}원</p>
                    </div>

                    <div id='favorite_item_list_inner_main_favorite_view'>
                        <p>관심 {favorite}</p>
                        <p>조회 {view}</p>
                    </div>
                </div>
