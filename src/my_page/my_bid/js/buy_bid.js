import '../css/buy_bid.css';
import axios from 'axios';

export default function Buy_bid(props) {
    ...
    return(
        <div id='buy_bid_div'>
            <div id='buy_bid_div_inner'>
                <div id='buy_bid_div_inner_header'>
                    <img alt='' src={`${img}`} onClick={view_detail_item}></img>
                </div>

                <div id='buy_bid_div_inner_main'>
                    <div id='buy_bid_div_inner_main_content'>
                        <p>{content}</p>
                    </div>

                    <div id='buy_bid_div_inner_main_price'>
                        <p>{price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}원</p>
                    </div>

                    <div id='buy_bid_div_inner_main_favorite_view'>
                        <p>관심 {favorite}</p>
                        <p>조회 {view}</p>
                    </div>
                </div>
